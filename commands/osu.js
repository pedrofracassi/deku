    ...
    if (username) {
      ...
      api.user.get(username).then(user => {
        if (user) {
          ...
          embed.addField(lang.commands.osu.global_ranking, '#' + nf.format(user.pp_rank.toLocaleString()), true);
          ...
          embed.addField(lang.commands.osu.total_score, nf.format(user.total_score.toLocaleString()), true);
          embed.addField(lang.commands.osu.ranked_score, nf.format(user.ranked_score.toLocaleString()), true);
